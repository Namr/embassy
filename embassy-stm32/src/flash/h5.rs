/// STM32H5 series flash impl. See RM0481
use core::{
    ptr::write_volatile,
...
use pac::flash::vals::NscrBksel;
use pac::flash::vals::OptcrSwapBank;
use pac::flash::vals::OptsrSwapBank;
...
pub(crate) unsafe fn blocking_erase_sector(sector: &FlashSector) -> Result<(), Error> {
    assert!(sector.index_in_bank < 127);
    ...
    interrupt::free(|_| {
        pac::FLASH.nscr().modify(|w| {
            ...
            w.set_bksel(match (sector.bank, banks_swapped()) {
                (FlashBank::Bank1, OptcrSwapBank::B_0X0) => NscrBksel::B_0X0,
                (FlashBank::Bank2, OptcrSwapBank::B_0X1) => NscrBksel::B_0X0,
                (FlashBank::Bank2, OptcrSwapBank::B_0X0) => NscrBksel::B_0X1,
                (FlashBank::Bank1, OptcrSwapBank::B_0X1) => NscrBksel::B_0X1,
            });
...
pub fn banks_swapped() -> OptcrSwapBank {
...
pub fn perform_bank_swap() {
    ...
    pac::FLASH.optsr_prg().modify(|w| w.set_swap_bank(match banks_swapped() {
        OptcrSwapBank::B_0X0 => OptsrSwapBank::B_0X1,
        OptcrSwapBank::B_0X1 => OptsrSwapBank::B_0X0,
    }));
